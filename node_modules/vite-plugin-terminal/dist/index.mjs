...
import { gray, lightGray, lightMagenta, lightBlue, lightYellow, lightRed } from 'kolorist';
...
function renderTable(rows, width, indent = 0, doneFirstLineIndent = 0) {
  ...
  function renderSeparator(chars) {
    const line = chars[1];
    const rows2 = Array.from({ length: nCols }).map((_, index) => gray(line.repeat(getCellWidth(index))));
...
export { pluginTerminal as default };
